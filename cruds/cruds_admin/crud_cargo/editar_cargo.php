                    ...
                    <tr>
                        ...
                        <td>
                            <div class="botones-acciones">
                                <form action="./controlador_cargo.php" method="POST" onsubmit="return confirmarEliminar();">
                                    <input type="hidden" name="ID_Cargo" value="<?= $cargo['ID_Cargo'] ?>">
                                    <input type="submit" name="eliminarCargo" value="Eliminar">
                                </form>
                                <form action="./actualizar_cargo.php" method="POST" onsubmit="return confirmarActualizar();">
                                    <input type="hidden" name="ID_Cargo" value="<?= $cargo['ID_Cargo'] ?>">
