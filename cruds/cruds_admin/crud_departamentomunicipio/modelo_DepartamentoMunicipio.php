...
function CrearDepartamento($Nombre_Departamento, $Descripcion_Departamento, $ID_Practicante, $ID_Empresa)
{
    AbrirConexion();
    global $conexion;

    $query = "INSERT INTO departamentos (Nombre_Departamento, Descripcion_Departamento, ID_Practicante, ID_Empresa)
              VALUES ('$Nombre_Departamento', '$Descripcion_Departamento', '$ID_Practicante', '$ID_Empresa')";
