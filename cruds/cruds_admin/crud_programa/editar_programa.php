                ...
                <tr>
                    ...
                    <td>
                        <div class="botones-acciones">
                            <form action="./controlador_programa.php" method="POST" onsubmit="return confirmarEliminar();">
                                <input type="hidden" name="ID_Programa" value="<?= $programa['ID_Programa'] ?>">
                                <input type="submit" name="eliminarPrograma" value="Eliminar">
                            </form>
                            <form action="./actualizar_programa.php" method="POST" onsubmit="return confirmarActualizar();">
                                <input type="hidden" name="ID_Programa" value="<?= $programa['ID_Programa'] ?>">
