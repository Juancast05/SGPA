...
<body>
    ...
    <div class="content">
        ...
        <form action="./controlador_programa.php" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas registrar los siguientes datos?');">
            <div class="form-group">
                ...
                <div class="form-input">
                    ...
                    <input type="text" name="ID_Practicante" id="ID_Practicante" required>
                </div>
            </div>
